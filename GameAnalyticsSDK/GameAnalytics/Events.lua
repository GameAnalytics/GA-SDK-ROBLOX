...
local function getEventAnnotations(playerId)
	...
	local annotations = {
		...
		-- SDK version
		["sdk_version"] = "android " .. version.SdkVersion,
...
function events:addProgressionEvent(playerId, progressionStatus, progression01, progression02, progression03, score)
	...
	local progressionStatusString = progressionStatusString(progressionStatus)
	...
	logger:i("Add PROGRESSION event: {status:" .. progressionStatusString .. ", progression01:" .. progression01 .. ", progression02:" .. progression02 .. ", progression03:" .. progression03 .. ", score:" .. tostring(score) .. ", attempt:" .. tostring(attempt_num) .. "}")
...
function events:addDesignEvent(playerId, eventId, value)
	-- Validate
	if not validation:validateDesignEvent(eventId, value) then
		-- TODO: add sdk error event
		return
	end
