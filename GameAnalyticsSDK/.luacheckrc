    ...
    read_globals = {
        ...
        Enum = {
            ...
            fields = {
                ...
                CollisionsMode = def_enum{"NoCollisions", "OtherMechanismsAnchored", "IncludeContactedMechanisms"};
                ComputerCameraMovementMode = def_enum{"Default", "Follow", "Classic", "Orbital", "CameraToggle"};
                ...
                DevComputerCameraMovementMode = def_enum{"UserChoice", "Classic", "Follow", "Orbital", "CameraToggle"};
                ...
                DraftStatusCode = def_enum{"OK", "DraftOutdated", "ScriptRemoved", "DraftCommitted"};
